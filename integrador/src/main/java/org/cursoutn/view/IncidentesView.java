...
public class IncidentesView {
    public void mostrarIncidente (int incidenteID, LocalDateTime fechaHoraIncidente, int tiempoNecesario, int esComplejo, State estadoIncidente, List<OperadorModel> operadores, ClienteModel cliente, List<TecnicoModel> tecnicos, List<TipoProblemaModel> problemasInvolucrados){
